...
const searchRestaurant = async (req: Request, res: Response) => {
  try {
    ...
    // search that matched this RegExp and ignore case
    ...
    const pageSize = 10;
    // skip is the number of pages to be skip
    // ex: when rendering page=2, we have to render from 1 * pageSize result
